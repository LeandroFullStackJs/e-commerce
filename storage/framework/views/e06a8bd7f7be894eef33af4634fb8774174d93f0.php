<header class="main-header">
            <a href="index.html" class="logo">
               ...
               <img src="<?php echo e(asset('admin-assets/dist/img/mini-logo.png')); ?>" alt="">
               </span>
               <span class="logo-lg">
               <img src="<?php echo e(asset('admin-assets/dist/img/logo.png')); ?>" alt="">
               </span>
            </a>
            <!-- Header Navbar -->
             ...
             <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                              ...
                              <ul class="menu">
                                 <li >
                                    ...
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="<?php echo e(asset('admin-assets/dist/img/basketball-jersey.png')); ?>" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>polo shirt</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="<?php echo e(asset('admin-assets/dist/img/shirt.png')); ?>" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Kits</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="<?php echo e(asset('admin-assets/dist/img/football.png')); ?>" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Football</h4>
                                 ...
                                 <li class="nav-list">
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="<?php echo e(asset('admin-assets/dist/img/shoe.png')); ?>" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Sports sheos</h4>
                           ...
                           <li>
                              <ul class="menu">
                                 <li>
                                    ...
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="<?php echo e(asset('admin-assets/dist/img/avatar.png')); ?>" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Ronaldo</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="<?php echo e(asset('admin-assets/dist/img/avatar2.png')); ?>" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Leo messi</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left" >
                                          <img src="<?php echo e(asset('admin-assets/dist/img/avatar3.png')); ?>" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Modric</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="<?php echo e(asset('admin-assets/dist/img/avatar4.png')); ?>" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Salman</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="<?php echo e(asset('admin-assets/dist/img/avatar5.png')); ?>" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Sergio Ramos</h4>
                     ...
                     <li class="dropdown dropdown-user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo e(asset('admin-assets/dist/img/avatar5.png')); ?>" class="img-circle" width="45" height="45" alt="user"></a>
                        <ul class="dropdown-menu" >
                           <li>
                              <a href="profile.html">
                           ...
                           <li><a href="login.html">
                              <i class="fa fa-sign-out" href="adminLogOut"></i> Signout</a>
                           </li>
                        </ul>
                     </li>
                  </ul>
         ...
         </header><?php /**PATH C:\xampp\htdocs\todofuncionando-master\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>