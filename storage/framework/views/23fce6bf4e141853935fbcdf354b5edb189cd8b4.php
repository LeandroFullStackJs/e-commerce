    ...
    <tbody>
        ...
        <?php $__currentLoopData = $Marks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Mark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td><a href="editMark/<?php echo e($Mark->id); ?>" class="btn btn-outline-secondary">modificar</a></td>
                <td><a href="deleteMark/<?php echo e($Mark->id); ?>" class="btn btn-outline-secondary">eliminar</a></td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\todofuncionando-master\resources\views/adminMarks.blade.php ENDPATH**/ ?>