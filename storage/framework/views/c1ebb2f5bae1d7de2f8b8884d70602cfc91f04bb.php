...
<br><br>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        Nombre:
        <input value="<?php echo e(old('name')); ?>" class="form-control" type="text" name="name" class="form-control" require>
        
        <br>


        Precio:
        <input value="<?php echo e(old('price')); ?>" type="text" name="price" class="form-control" require>
        <br>



        Stock:
        <input value="<?php echo e(old('stock')); ?>" type="number" name="stock" class="form-control" require>
        <br>



        Descripción:
        <input value="<?php echo e(old('description')); ?>" type="textarea" name="description" class="form-control" require>
        <br>
...
<?php /**PATH C:\xampp\htdocs\todofuncionando-master\resources\views/addProduct.blade.php ENDPATH**/ ?>