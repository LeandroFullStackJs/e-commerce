...
<body>
 ...
 <?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <tbody>
        ...
        <?php $__currentLoopData = $Categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td><a href="editCategory/<?php echo e($Category->id); ?>" class="btn btn-outline-secondary">modificar</a></td>
                <td><a href="deleteCategory/<?php echo e($Category->id); ?>" class="btn btn-outline-secondary">eliminar</a></td>
            </tr>
    ...
    </html><?php /**PATH C:\xampp\htdocs\todofuncionando-master\resources\views/adminCategories.blade.php ENDPATH**/ ?>