...
<br><br>
    ...
    <?php endif; ?>
        ...
        <form action="" method="post">
            ...
            Marca:
            <br>
            <input type="text" name="name" class="form-control" value="<?php echo e(old('name', $Mark->name)); ?>">
            <br>
...
</html><?php /**PATH C:\xampp\htdocs\todofuncionando-master\resources\views/editMark.blade.php ENDPATH**/ ?>