                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="payment-icon">
                                        <ul>
                                            <li><img class="img-fluid" src="<?php echo e(asset('front_assets/images/payment-icon/1.png')); ?>" alt=""></li>
                                            <li><img class="img-fluid" src="<?php echo e(asset('front_assets/images/payment-icon/2.png')); ?>" alt=""></li>
                                            <li><img class="img-fluid" src="<?php echo e(asset('front_assets/images/payment-icon/3.png')); ?>" alt=""></li>
                                            <li><img class="img-fluid" src="<?php echo e(asset('front_assets/images/payment-icon/5.png')); ?>" alt=""></li>
                                            <li><img class="img-fluid" src="<?php echo e(asset('front_assets/images/payment-icon/7.png')); ?>" alt=""></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\todofuncionando-master\resources\views/checkout.blade.php ENDPATH**/ ?>